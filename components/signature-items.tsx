      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div ref={headRef} className="text-center mb-16">
          <motion.div
            ...
            className="mb-2"
          >
            <span className="text-[#3d8b0a] text-[3rem] sm:text-[5.5rem] md:text-[9rem] lg:text-[13.5rem] font-black uppercase tracking-tight leading-none">
              Signature Items
            </span>
          </motion.div>
          <motion.h2
            ...
            className="text-3xl sm:text-4xl md:text-6xl font-black uppercase text-[rgba(0,0,0,0.87)] leading-[1.05]"
          >
