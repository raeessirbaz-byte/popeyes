      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div ref={headRef} className="text-center mb-12">
          <motion.div
            ...
            className="mb-16"
          >
            <span className="text-[#3d8b0a] text-[5rem] sm:text-[7rem] md:text-[9rem] lg:text-[13.5rem] font-black uppercase tracking-tight leading-none">
              Menu
            </span>
          </motion.div>
          <motion.h2
            ...
            className="text-3xl sm:text-4xl md:text-6xl font-black uppercase text-[rgba(0,0,0,0.87)] leading-[1.05] mb-5"
          >
